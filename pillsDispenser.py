...
GRIPPER_CLOSE_ANGLE = 135  # increase if you want the clamp to squeeze harder
...
# LIFT & DROP TUNING
TRANSPORT_LIFT_J3 = 35    # how much we lift at joint 3 when travelling
DROP_DOWN_J3      = -14   # how much we lower at drop so the tray doesn’t fall from too high
